  ...
  return (
    <div className="Create FlashCard Page ">
      <nav className="flex flex-row items-center  justify-between shadow-[4.0px_8.0px_8.0px_rgba(0,0,0,0.38)]  px-[0.5%] py-[1%]  bg-white">
        ...
        >
          FlashKrew <img src="https://png.pngtree.com/png-vector/20230504/ourmid/pngtree-flash-card-flat-icon-vector-png-image_7084651.png" alt=''  width={50}></img>
        </NavLink>
     ...
     <div className="flex flex-col h-[100vh] items-center pt-[10%]">
      <h1 className="sm:text-1xl ml-10 md:text-2xl font-bold ">Page Not found! Please use the below links</h1>
      ...
      <NavLink
          ...
          className={({ isActive }) =>
            isActive
              ? " flex text-lg font-sans scale-105 text-blue-600 sm:text-1xl  md:text-2xl  mx-3 my-1  hover:text-blue  transition-all"
              : " flex text-lg font-sans  sm:text-1xl text-blue-600 md:text-2xl mx-3 my-1   hover:text-blue  transition-all"
          }
        >
          Create New
        </NavLink>
